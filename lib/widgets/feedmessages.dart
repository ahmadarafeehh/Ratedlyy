...
class FeedMessages extends StatelessWidget {
  ...
  Widget _buildUserAvatar(String photoUrl, List<dynamic> ratings) {
    final totalRating = ratings.fold<double>(
        0.0, (acc, rating) => acc + (rating['rating'] as num).toDouble());
    final averageRating =
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return FutureBuilder(
                        ...
                        builder:
                          ...
                          if (!isExistingChat) {
                            return ListTile(
                              leading: _buildUserAvatar(photoUrl, ratings),
                              title: Text(username,
                                  style: TextStyle(color: _textColor)),
                              ...
                              return StreamBuilder<int>(
                                ...
                                builder: (context, unreadSnapshot) {
                                  ...
                                  return Container(
                                    ...
                                    child: ListTile(
                                      leading:
                                          _buildUserAvatar(photoUrl, ratings),
                                      title: Text(username,
                                          style: TextStyle(color: _textColor)),
                                      subtitle: Row(
                                        children: [
