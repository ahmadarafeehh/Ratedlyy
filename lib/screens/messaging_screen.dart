...
class _MessagingScreenState extends State<MessagingScreen> {
    ...
    return GestureDetector(
      ...
      child: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final ratings = List<dynamic>.from(userData['ratings'] ?? []);

          return Row(
            children: [
              _buildUserAvatarWithRating(
  ...
  Widget _buildUserAvatarWithRating(String photoUrl, List<dynamic> ratings) {
    final averageRating = ratings.isNotEmpty
        ? ratings.fold<double>(0.0, (sum, r) => sum + (r['rating'] as num)) /
        ratings.length
        : 0.0;
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Stack(
                            clipBehavior: Clip.none,
                            children: [
                              // Update the CircleAvatar in _buildPostMessage
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _formatTimestamp(data['timestamp']),
                          style: TextStyle(
                              color: _textColor.withOpacity(0.6), fontSize: 10),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _buildBlockedPostMessage() {
    return Padding(
      padding: const EdgeInsets.all(12),
      child: Row(
        children: [
