    ...
    return Positioned(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: _backgroundColor, width: 1), // Added border
          boxShadow: const [
            BoxShadow(
              color:
              Colors.black26, // Changed from black12 to match comment card
              blurRadius: 3,
              offset: Offset(0, 2),
            )
          ],
                ...
                builder: (context, userSnapshot) {
                  final userData =
                      (userSnapshot.data?.data() as Map<String, dynamic>?) ??
                          {};
                  final ratings = userSnapshot.hasData
                      ? List<dynamic>.from((userSnapshot.data!.data()
