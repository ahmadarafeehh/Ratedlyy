  ...
  Future<void> getData() async {
    ...
    try {
      ...
      if (userDoc.exists) {
        ...
        final ratings = _convertToList(data['ratings']);
        final total = ratings.fold<double>(0.0, (acc, r) {
        ...
        final avg = ratings.isNotEmpty ? total / ratings.length : 0.0;
        final voterIds = ratings.map((r) => r['raterUserId']).toSet();
